...
export const genericCosmetic: CosmeticGroup = {
  ...
  default: [
    ...
    // Ströer's slot library (transfermarkt.de, t-online.de, kicker.de and the
    // rest of the German publisher network). It reserves the slot box up front,
    // so blocking the ad request alone leaves a banner-sized hole with a
    // spinner in it. Every one of these ids/classes is generated by the ad tag.
    '[id^="sdgSlotContainer-"]',
    '[id^="sdgSlotHull-"]',
    '[id^="sdgAdServerAnchor-"]',
    '[id^="sdgLoadingSpinner-"]',
    '.sdgSlotContainer',
    '.sdgSlotHull',
    '.sdgAdServerAnchor',
    '.sdgSpinner',
    // German publishers label their reserved ad space literally — "Werbung"
    // (advertisement) and "Anzeige" (ad). These are the placement wrappers
    // themselves, server-rendered so they survive network blocking.
    '.ad-placement-note',
    'div.werbung',
    'div.anzeige',
