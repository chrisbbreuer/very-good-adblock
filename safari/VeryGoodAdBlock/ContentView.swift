...
let extensionBundleIdentifier = "org.verygoodadblock.VeryGoodAdBlock.Extension"
...
struct ContentView: View {
    ...
    private var statusText: String {
        ...
        case .none:
            return "This app contains the Very Good AdBlock Safari extension. Enable it in Safari → Settings → Extensions."
        }
    }
